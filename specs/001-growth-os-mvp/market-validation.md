...
Private beta priority segment:

- Parents of children aged 4-7
- At least one ongoing interest or habit direction
- A real companionship friction occurred in the last 30 days
- Parent is willing to try at least one AI suggestion during a 14-day pilot

Priority friction examples:

- Piano or interest-practice conflict
- Reading habit interruption
- Unclear English exposure
- Limited evening time for companionship

Broad "education-interested" families without recent friction are lower priority for the pilot because they may validate concept appeal without proving urgency or willingness to pay.
...
> 我们在做一个 AI 家庭陪伴教练，不是学习软件，也不是打卡工具。它会根据你家孩子的年龄、特点和最近困扰，给你一个今晚就能用的陪伴建议。我们正在找 4-7 岁、最近有练琴/阅读/英语/陪伴时间冲突的家庭试用 14 天，看它能不能真的帮你少一点冲突、多一点方法。

Qualifying questions:

- 孩子年龄？
- 过去 30 天有没有出现过练琴、阅读、英语、运动、情绪或陪伴时间上的具体摩擦？
- 最近最常见的陪伴困扰是什么？
- 现在是否有阅读、英语、运动、钢琴、情绪表达等关注方向？
- 你是否愿意在 14 天内尝试至少一次 AI 给出的陪伴建议？
...
- 如果产品分为 19/29/49 元每月的不同套餐，你会考虑哪个？为什么？
- 你会不会推荐给同龄孩子父母？
- 你下周还会打开它问什么？
...
- Step 8 -> 9 drop: usage value does not translate into payment value
...
Experiment D: Reading recovery framing

- Headline: "最近阅读断了，不用补任务，先找回一个轻松开始"
- Expected strength: parents with broken routines and low tolerance for pressure

Experiment E: English exposure framing

- Headline: "英语启蒙不知道怎么做？先从今晚 10 分钟亲子输入开始"
- Expected strength: parents who want concrete action but do not want curriculum pressure
...
Risk: Pilot feedback is positive but commercially weak.
...
- The product may get warm feedback from broad users but fail among high-pain users who would actually pay.
...
- Run a 14-day private beta with 30 high-pain families focused on one action loop: ask, accept, try, record, return, and payment-intent test.
