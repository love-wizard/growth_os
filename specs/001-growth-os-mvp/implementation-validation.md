...
- Vitest: passed through 17 test files and 48 tests
...
- OpenAI calls are server-side and can fall back to deterministic structured responses when `OPENAI_API_KEY` is absent.
